...
export const initialChords = [
  { chordName: 'A,,,', string: 'X 0 2 2 2 0', fingering: 'X X 2 3 4 X' },
  { chordName: 'B,,,', string: 'X 2 4 4 4 2', fingering: 'X 1 2 3 4 1' },
  { chordName: 'C,,,', string: 'X 3 2 0 1 0', fingering: 'X 3 2 X 1 X' },
  { chordName: 'D,,,', string: 'X X 0 2 3 2', fingering: 'X X X 1 3 2' },
  { chordName: 'E,,,', string: '0 2 2 1 0 0', fingering: 'X 2 3 1 X X' },
  { chordName: 'F,,,', string: '1 3 3 2 1 1', fingering: '1 3 4 2 1 1' },
  { chordName: 'G,,,', string: '3 2 0 0 3 3', fingering: '2 1 X X 3 4' },
];
